odoo.define('ks_dashboard_ninja_list.ks_dashboard_graph_preview', function (require) {
    ...
    var KsGraphPreview = AbstractField.extend(form_common.ReinitializeFieldMixin, {
        ...
        render_value: function () {
            ...
            for (var key in self.view.fields) {
                field[key] = self.view.fields[key].get_value();
            }
            this.recordData = field
            this.$el.empty()
            if (this.recordData.ks_dashboard_item_type !== 'ks_tile' && this.recordData.ks_dashboard_item_type !== 'ks_list_view') {
            // if (self.view.fields["ks_dashboard_item_type"].get_value() !== 'ks_tile' && self.view.fields["ks_dashboard_item_type"].get_value() !== 'ks_list_view') {
        ...
        _getChartData: function () {
            ...
            else if (field.ks_model_name) ks_chart_name = self.view.fields['ks_model_id'].current_display;
