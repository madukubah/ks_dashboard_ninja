odoo.define('ks_dashboard_ninja_list.ks_dashboard_item_preview', function (require) {
    ...
    var KsItemPreview = form_common.AbstractField.extend( form_common.ReinitializeFieldMixin, {
        ...
        render_value: function () {
            ...
            // console.log( "ks_model_id" );
            // console.log( self.view.fields['ks_model_id'] );
            ...
            item_info = {
                ...
                count: field.ks_record_count.toLocaleString(),
            ...
            if (!field.name) {
                if (field.ks_model_name) {
                    item_info['name'] = self.view.fields['ks_model_id'].current_display;
                } else {
                    item_info['name'] = "Name";
                }
            }
