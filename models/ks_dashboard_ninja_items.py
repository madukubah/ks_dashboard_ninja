...
class KsDashboardNinjaItems(models.Model):
    ...
    ks_record_count = fields.Float(string="Record Count", compute='ks_get_record_count', readonly=True, default=0)
    ...
    ks_graph_preview = fields.Integer(default=1, string="Preview")
    ...
    ks_goal_bar_line = fields.Boolean(string="Show Target As Line", default=False)
    ks_standard_goal_value = fields.Float(string="Standard Target", default=0)
    ...
    # @api.multi
    # @api.onchange('ks_chart_measure_field', 'ks_chart_relation_groupby', 'ks_chart_date_groupby', 'ks_domain',
    ...
    # def ks_graph_preview_update(self):
    #     self.ks_graph_preview += 1
    @api.multi
